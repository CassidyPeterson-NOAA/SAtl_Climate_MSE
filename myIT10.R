...
myIT10_BSB<- function (x, Data, reps = 100, plot = FALSE, yrsmth = 5, mc = 0.1, index="AddInd", ii=1, c=1.5)
{
...
myIT10_RP<- function (x, Data, reps = 100, plot = FALSE, yrsmth = 5, mc = 0.1, index="AddInd", ii=1, c=0.95)
{
  myIT_<-function (x, Data, reps, plot , yrsmth , mc, index, ii, c)
  {
    dependencies = "Data@Ind, Data@MPrec, Data@CV_Ind, Data@Iref, Data@AddInd "
...
myIT10_VS<- function (x, Data, reps = 100, plot = FALSE, yrsmth = 5, mc = 0.1, index="AddInd", ii=1, c=0.8)
{
  myIT_<-function (x, Data, reps, plot , yrsmth , mc, index, ii, c)
  {
    dependencies = "Data@Ind, Data@MPrec, Data@CV_Ind, Data@Iref, Data@AddInd "
