...
```{r BSB_O-biomass1-PM, echo=FALSE, fig.height=5, fig.width=9, fig.cap = "Figure 5. Relative $SSB/SSB_{MSY}$ at year 30 by MP for each OM."}
...
```{r BSB_O-F1-PM, echo=FALSE, fig.height=5, fig.width=9, fig.cap = "Figure 7. Relative $F/F{MSY}$ at year 30 by MP for each OM."}
par(mfrow=c(3,3), mar=c(2.4, 2.4, 0.2, 0.2), mgp=c(1.1, 0.25, 0), tck=-0.01, cex.axis=1)
myPlot_Violin(get(paste0(sp,"_PM_nest")), stat='relF30', ylimsEpiM=c(0,25), legend=F, mf=c(3,3))
```


```{r BSB_O-F2-PM, echo=FALSE, fig.height=5, fig.width=9, fig.cap = "Figure 8. Probability of not overfishing (PNOF) across the 50-year projection period by MP for each OM."}
par(mfrow=c(3,3), mar=c(2.4, 2.4, 0.2, 0.2), mgp=c(1.1, 0.25, 0), tck=-0.01, cex.axis=1)
...
```{r BSB_O-Yield1-PM, echo=FALSE, fig.height=5, fig.width=9, fig.cap = "Figure 9. Relative yield (yield / MSY) at projection year 30 by MP for each OM."}
 par(mfrow=c(3,3), mar=c(2.4, 2.4, 0.2, 0.2), mgp=c(1.1, 0.25, 0), tck=-0.01, cex.axis=1)
 myPlot_Violin(get(paste0(sp,"_PM_nest")), stat='yield30', legend=F, mf=c(3,3), ylimsrecns=c(0,15))
```


```{r BSB_O-Yield2-PM, echo=FALSE, fig.height=5, fig.width=9, fig.cap = "Figure 10. Cumulative relative yield (yield / MSY) at projection year 30 by MP for each OM."}
 par(mfrow=c(3,3), mar=c(2.4, 2.4, 0.2, 0.2), mgp=c(1.1, 0.25, 0), tck=-0.01, cex.axis=1)
...
```{r BSB_O-cumulative-PM-plot, echo=FALSE, fig.height=5, fig.width=7, fig.cap = "Figure 11. MP performance across OMs"}
