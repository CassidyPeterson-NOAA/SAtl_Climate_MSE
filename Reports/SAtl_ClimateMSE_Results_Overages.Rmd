---
title: "SAtl_Climate_MSE_Results - All Species with Overages"
...
Below are the results for vermilion snapper (VS) with implementation overages. 
...
```{r echo=FALSE,   fig.height=9, fig.height=9,fig.cap = "Median SSB / dynSSB0 trajectories for empirical MPs"}
...
Below are the results for black sea bass (BSB) with implementation overages. 
...
#### Biomass Performance Metrics
```{r BSB-biomass-PM, echo=FALSE, fig.height=7, fig.width=9, fig.cap = "OM-specific MP biomass performance"}
...
myPlot_Violin(get(paste0(sp,"_PM_nest")), stat='treldSSB0', ylims=c(0,1.1), refline2=reflinetemp)
 PlotRelPM(sp, calc='rd', Pstat='treldSSB0',
            baserefline=c(1,reflinetemp), refline=0,
            maxylim=c(1.1, 4, 4, 2, 4, 3, 2, 1, 1.5, 1.5, 3), #BSB
            minylim=c(0, rep(-1.05,10))) ## PLEASE NOTE THAT OUTLIERS HAVE BEEN CUT OFF
...
myPlot_Violin(get(paste0(sp,"_PM_nest")), stat='t10reldSSB0', ylims=c(0,1.1), refline2=reflinetemp)
  PlotRelPM(sp, calc='rd', Pstat='t10reldSSB0',
            baserefline=c(1, reflinetemp), refline=0,
            maxylim=c(1.1, 2.5, 3, 2, 4, 3, 2, 1, 1.5, 1.5, 3), #BSB
            minylim=c(0, rep(-1.05,10)) ) ## PLEASE NOTE THAT OUTLIERS HAVE BEEN CUT OFF
...
myPlot_Violin(get(paste0(sp,"_PM_nest")), stat='P100', ylims=c(0,1.1), refline2=0.5)
  PlotRelPM(sp, calc='rd', Pstat='P100',
            baserefline=1, refline=0,
            maxylim=c(1.1, 10, 0.5, 1.75, 5, 3, 1.5, 1, 2, 1, 2.5), #BSB
            minylim=c(0, rep(-1.05,10))) ## PLEASE NOTE THAT OUTLIERS HAVE BEEN CUT OF

```
#### Fishing mortality metrics
```{r BSB-F-PM, echo=FALSE, warning=FALSE, fig.height=7, fig.width=9, fig.cap = "OM-specific MP fishing mortality performance"}
...
PlotRelPM(sp, calc='rd', Pstat='PNOF',
            baserefline=1, refline=0,
            maxylim=c(1.1, 1, 1, 1.25, 1.25, 1.25, 1.25, 1, 1.25, 1, 1.25), #BSB
            minylim=c(0, rep(-1.05,10))) ## PLEASE NOTE THAT OUTLIERS HAVE BEEN CUT OF
...
#### Yield metrics
```{r BSB-yield-plots, echo=FALSE, fig.height=7, fig.width=9, fig.cap = "OM-specific MP yield performance"}
...
PlotRelPM(sp, calc='rd', Pstat='cyield',
            ...
            minylim=c(0, -1, -0.75, -1,  -0.25, -1, -1, -.5, -0.5, -0.5, -1) ) ## PLEASE NOTE THAT OUTLIERS HAVE BEEN CUT OFF
...
#### Cumulative Performance Metrics
```{r BSB-cumulative-PM-plot, echo=FALSE, fig.height=5, fig.cap = "MP performance across OMs"}
...
#### Trade off plots
```{r BSB-trade-off-plots, echo=FALSE, fig.height=5, fig.cap = "MP performance across OMs"}
### Tradeoff plot
spp_pm<-get(paste(sp, "PM", sep="_"))
...
#### Worm plots
```{r BSB-worm-plots, echo=FALSE, fig.height=5, fig.cap = "MP performance across OMs"}
nms<-get(sp)$base@MPs
# cbind(MP_namesR_leg,orderedMPs)
mpnms<-nms[c(1,7,8)]
# names(get(sp))
...
Below are the results for red porgy (RP) with implementation overages. 
...
#### Biomass Performance Metrics
```{r RP-biomass-PM, echo=FALSE, fig.height=7, fig.width=9, fig.cap = "OM-specific MP biomass performance"}
...
```
#### Fishing mortality metrics
```{r RP-F-PM, echo=FALSE, warning=FALSE, fig.height=7, fig.width=9, fig.cap = "OM-specific MP fishing mortality performance"}
...
#### Yield metrics
```{r RP-yield-plots, echo=FALSE, fig.height=7, fig.width=9, fig.cap = "OM-specific MP yield performance"}
...
#### Cumulative Performance Metrics
```{r RP-cumulative-PM-plot, echo=FALSE, fig.height=5, fig.cap = "MP performance across OMs"}
...
#### Trade off plots
```{r RP-trade-off-plots, echo=FALSE, fig.height=5, fig.cap = "MP performance across OMs"}
### Tradeoff plot
spp_pm<-get(paste(sp, "PM", sep="_"))
...
#### Worm plots
```{r RP-worm-plots, echo=FALSE, fig.height=5, fig.cap = "MP performance across OMs"}
nms<-get(sp)$base@MPs
# cbind(MP_namesR_leg,orderedMPs)
mpnms<-nms[c(1,7,8)]
# names(get(sp))
