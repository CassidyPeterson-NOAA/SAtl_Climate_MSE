...
```{r VS_O-biomass-PM, echo=FALSE, fig.height=7, fig.width=9, fig.cap = "OM-specific MP biomass performance"}
...
```{r VS_O-F-PM, echo=FALSE, warning=FALSE, fig.height=7, fig.width=9, fig.cap = "OM-specific MP fishing mortality performance"}
...
#### Yield metrics
```{r VS_O-yield-plots, echo=FALSE, fig.height=7, fig.width=9, fig.cap = "OM-specific MP yield performance"}
...
```{r VS_O-cumulative-PM-plot, echo=FALSE, fig.height=5, fig.cap = "MP performance across OMs"}
...
#### Trade off plots
```{r VS_O-trade-off-plots, echo=FALSE, fig.height=5, fig.cap = "MP performance across OMs"}
### Tradeoff plot
...
#### Worm plots
```{r VS_O-worm-plots, echo=FALSE, fig.height=5, fig.cap = "MP performance across OMs"}
nms<-get(sp)$base@MPs
...
#### Biomass Performance Metrics
```{r BSB_O-biomass-PM, echo=FALSE, fig.height=7, fig.width=9, fig.cap = "OM-specific MP biomass performance"}
...
myPlot_Violin(get(paste0(sp,"_PM_nest")), stat='t10reldSSB0', ylims=c(0,1.1), refline2=reflinetemp)
  PlotRelPM(sp, calc='rd', Pstat='t10reldSSB0',
            baserefline=c(1, reflinetemp), refline=0,
            maxylim=c(1.1, 2.5, 3, 2, 4, 3, 2, 1, 1.5, 1.5, 3), #BSB_O
            minylim=c(0, rep(-1.05,10)) ) ## PLEASE NOTE THAT OUTLIERS HAVE BEEN CUT OFF
...
myPlot_Violin(get(paste0(sp,"_PM_nest")), stat='P100', ylims=c(0,1.1), refline2=0.5)
  PlotRelPM(sp, calc='rd', Pstat='P100',
            baserefline=1, refline=0,
            maxylim=c(1.1, 10, 0.5, 1.75, 5, 3, 1.5, 1, 2, 1, 2.5), #BSB_O
            minylim=c(0, rep(-1.05,10))) ## PLEASE NOTE THAT OUTLIERS HAVE BEEN CUT OF

```
#### Fishing mortality metrics
```{r BSB_O-F-PM, echo=FALSE, warning=FALSE, fig.height=7, fig.width=9, fig.cap = "OM-specific MP fishing mortality performance"}
...
PlotRelPM(sp, calc='rd', Pstat='cyield',
            baserefline=50, refline=0,
            maxylim=c(100, 0.2, 2.5, 1.5, 5, 0.1, 1.5, 0.5, 0.5, 0.3, 0.3), #BSB_O
...
#### Cumulative Performance Metrics
```{r BSB_O-cumulative-PM-plot, echo=FALSE, fig.height=5, fig.cap = "MP performance across OMs"}
...
#### Trade off plots
```{r BSB_O-trade-off-plots, echo=FALSE, fig.height=5, fig.cap = "MP performance across OMs"}
### Tradeoff plot
spp_pm<-get(paste(sp, "PM", sep="_"))
...
#### Worm plots
```{r BSB_O-worm-plots, echo=FALSE, fig.height=5, fig.cap = "MP performance across OMs"}
nms<-get(sp)$base@MPs
# cbind(MP_namesR_leg,orderedMPs)
mpnms<-nms[c(1,7,8)]
# names(get(sp))
