...
This document shows the performance of the model-based EMs from a South Atlantic MSE exercise for black sea bass (BSB), vermilion snapper (VS), and red porgy (RP) using the openMSE software ([Blue Matter Science](bluematterscience.com)). Analyses are based on the base-case OM scenario at the end of the historical period compared to the first application of the EM. 
