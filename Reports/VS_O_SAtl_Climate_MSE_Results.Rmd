---
title: "SAtl_Climate_MSE_Results - Vermilion Snapper Overages"
...
Below are the results for VS with implementation overages (VS_O). 
...
```{r VS_O-indices-plots, echo=FALSE, fig.height=5, fig.cap = "Observed indices of abundance"}
base<-get(sp)[["base"]]
